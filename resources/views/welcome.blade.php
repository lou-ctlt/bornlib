@extends('layouts.app')
    ...
    @section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-5">
                    <h1 class="text-center mt-3 pt-3 font-bornlib">BORN'LIB</h1>
                ...
                <div class="col-md-7">
                    ...
                    Simplifiez la recharge de votre véhicule électrique avec <h1 class="text-center font-bornlib">BORN' LIB!</h1>
                    </h3>
